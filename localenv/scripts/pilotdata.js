var pilotNav = document.querySelector('pilot-nav');
        var newPilot = document.createElement('div'); newPilot.innerHTML=`<style>body { margin: 0; } .phx-banner-placeholder { display: block; height: 56px; background: #000; } .phx-root { display: none; } </style> <div class="phx-banner-placeholder"></div>
